...
matches.names  <- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Original IV/matched_originalIV",sep="",1995:2005,".csv")
...
for(k in 1:length(data.names)){
  ...
  X.reduced=cbind(bthwght,gestage,gestdiabetes,singlebirth,parity,ageM,medu,white,race.mis,below_poverty);
...
data.names     <- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Preemie Data/preemies",sep="",1995:2005,".csv")
matches.names  <- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Stronger IV/matched_strongerIV",sep="",1995:2005,".csv")
...
############################Combine all the unmatched data################
data.names<- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Preemie Data/preemies",sep="",1995:2005,".csv")
unmatched_allyears<-NULL
for (i in 1:length(data.names)){
  tmp=read.csv(data.names[i])
  unmatched_allyears<-rbind(unmatched_allyears, tmp)
  print(i)
}

write.csv(unmatched_allyears, "C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Preemie Data/allyears_preemie_data.csv")



###########################Combine all the matched data#####################
matches.names_originalIV  <- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Original IV/matched_originalIV",sep="",1995:2005,".csv")
matches.names_strongerIV  <- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Stronger IV/matched_strongerIV",sep="",1995:2005,".csv")
...
write.csv(matched_allyears_originalIV, "C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Original IV/allyears_matched_originalIV.csv")
...
write.csv(matched_allyears_strongerIV, "C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Stronger IV/allyears_matched_strongerIV.csv")

####################Report Table#################################

preemiedata<-read.csv("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Preemie Data/allyears_preemie_data.csv")
...
preemie_data_imputed<-data.frame(dif.travel.time, high_level_NICU, losI, death, death_fatel, bthwght, gestage, gestdiabetes, singlebirth, parity, ageM, medu, white, race.mis, below_poverty)

write.csv(preemie_data_imputed, "C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Preemie Data/allyears_preemie_data_imputed.csv")
