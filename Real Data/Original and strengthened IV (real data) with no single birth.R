...
store.matches <- function(matchdataframe,encouraged.numbers, encouraged.match, select1row, dif.travel.time, X, high_level_NICU, singlebirth, death_fatel, losI, matchcount){
  ...
  matchdataframe[(matchcount+1):(matchcount+noe),n.X+4]=(singlebirth[select1row])[encouraged.numbers];  
  ...
  matchdataframe[(matchcount+1):(matchcount+noe),2*n.X+9]=(singlebirth[select1row])[encouraged.match];
...
matches.names  <- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Original IV no single birth/matched_originalIV_no_singlebirth",sep="",1995:2005,".csv")
...
for(k in 1:length(data.names)){
  ...
  X.reduced=cbind(bthwght,gestage,gestdiabetes,parity,ageM,medu,white,race.mis,below_poverty);
  ...
  varnames=c("dif.travel.time.e",paste(X.names,sep="",".e"),"high_level_NICU.e", "losI.e", "singlebirth.e", "death_fatel.e",
             "dif.travel.time.u",paste(X.names,sep="",".u"),"high_level_NICU.u", "losI.u", "singlebirth.u", "death_fatel.u")
  ...
  for(i in 1:(num.strata-1)){
    ...
    # Save matches
    matchdataframe <- store.matches(matchdataframe,encouraged.numbers, encouraged.match, select1row, dif.travel.time, X.reduced, high_level_NICU, singlebirth, death_fatel, losI, matchcount)
...
data.names     <- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Preemie Data/preemies",sep="",1995:2005,".csv")
matches.names  <- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Stronger IV no single birth/matched_strongerIV_no_singlebirth",sep="",1995:2005,".csv")
...
matches.names_originalIV  <- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Original IV no single birth/matched_originalIV_no_singlebirth",sep="",1995:2005,".csv")
matches.names_strongerIV  <- paste("C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Stronger IV no single birth/matched_strongerIV_no_singlebirth",sep="",1995:2005,".csv")
...
write.csv(matched_allyears_originalIV, "C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Original IV no single birth/allyears_matched_originalIV_no_singlebirth.csv")
...
write.csv(matched_allyears_strongerIV, "C:/Users/siyuheng/Desktop/Real Data Analysis for Strengthening IV/Data/Stronger IV no single birth/allyears_matched_strongerIV_no_singlebirth.csv")
